...
RESULTS_PATH = ROOT / "Elastic net sector model" / "bist_elasticnet_sector_models.xlsx"
MARKET_CAP_PATH = ROOT / "all_tickers_quarterly_2016_2026.csv"

OUTPUT_RESULTS_TEMPLATE = ROOT / "Elastic net sector model" / "bist_mean_reversion_elasticnet_{sector}.xlsx"
OUTPUT_COMBINED = ROOT / "Elastic net sector model" / "bist_mean_reversion_elasticnet_all_sectors.xlsx"
OUTPUT_PLOT = ROOT / "Elastic net sector model" / "bist_mean_reversion_by_overvaluation_elasticnet.png"
...
def plot_decile(df, ret_col="Return_4Q"):
    ...
    dec.plot(kind="bar", color="#2E86AB", edgecolor="black")
    plt.axhline(0, color="red", linestyle="--", linewidth=1.5)
    plt.title("Mean Forward Returns by Overvaluation Decile (ElasticNet)")
...
def main():
    ...
    # Overall pooled (if present)
    pooled = load_results_sheet("Pooled_EN_All", excel=xl)
